# Glock
A blockchain implemented in Go, following Ivan Kuznetsov's [blog](https://jeiwan.net/): Building Blockchain in Go, as a learning exercise. 

Implementation details are described in these articles:
